...
public partial class StatusOfAnalysis : BasePage   //System.Web.UI.Page
    ...
    string City = "";
        ...
        protected void btnNCity_Click(object sender, EventArgs e)
        {
            ...
            Yvalue[0] = int.Parse(strs[0].ToString());
            Yvalue[1] = int.Parse(strs[1].ToString());
            Yvalue[2] = int.Parse(strs[2].ToString());
            Yvalue[3] = int.Parse(strs[3].ToString());
            Yvalue[4] = int.Parse(strs[4].ToString());

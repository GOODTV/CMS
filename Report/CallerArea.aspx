<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="CallerArea.aspx.cs" Inherits="CallerArea" %>
...
<body class="body">
    <form id="Form1" runat="server">
        ...
        <h1>
            ...
            <asp:Literal ID="litTitle" runat="server" Text="來電數區域分佈"></asp:Literal>
        </h1>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v">
            <tr>
                ...
                <th align="right" nowrap>電話：</th>
                <td><asp:TextBox ID="txtPhone" runat="server"></asp:TextBox></td>
                <th align="right" nowrap>年齡： </th>
            ...
            <tr>
                <th align="right" nowrap>查詢地址：</th>
                <td colspan="1" align="left" nowrap>縣市：<asp:DropDownList ID="ddlCity" runat="server" Height="25px"></asp:DropDownList>
                    <%--區鄉鎮：<asp:DropDownList ID="ddlArea" runat="server" ></asp:DropDownList>--%>
                </td>
                <th align="right" nowrap>時間區間：</th>
                <td nowrap>
                ...
                <!--td colspan="2">
                    <asp:CheckBox ID="CKB_Christian" runat="server" Text="是否為基督徒" />
                </td-->
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style4" colspan="20">
                    <asp:Chart ID="Chart1" runat="server" BackColor="WhiteSmoke" Height="1000px" Width="1100px" BorderlineDashStyle="Solid" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2px" BorderColor="#1A3B69" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)">
                        <Titles>
                            <asp:Title runat="server" ShadowColor="32, 0, 0, 0" Font="Arial Unicode MS, 14.25pt, style=Bold" ShadowOffset="3" Text="來電數區域分佈" Name="Title1" ForeColor="26, 59, 105"></asp:Title>
                        </Titles>
                          <Legends>
                            <%--圖利字型--%>

...
public partial class SearchCallerCategory : BasePage
{
    ...
    private string getCnt1(string ConsultantMain)
    {
        ...
        string strSql = @" 
                            select count(*) as sum
                            from consulting a left join member b on a.MemberUID = b.uid
                            where 1=1
        ...
        if (rdoChristianYN.SelectedValue == "是")
        {
            strSql += " and  Christian = '是'";
        }
        else if (rdoChristianYN.SelectedValue == "否")
        {
            strSql += " and  Christian = '否'";
        }
        else
        {

        }
        if (ddlAge.SelectedItem.ToString() != "未明" && ddlAge.SelectedItem.ToString() != "")
        {
            strSql += " and  Age = '" + ddlAge.SelectedItem.ToString() + "'";
        }
        if (rdoSex.SelectedValue != "" && rdoSex.SelectedValue != "全部")
        {
            strSql += " and  sex = '" + rdoSex.SelectedValue + "'";
        }
        DataRow dr = null;
...
/////////////////////////////////////////   第一行 by apple  //////////////////////////////////////////////////////////////////
    ...
    private string getCnt2(string ConsultantItem)
    {
        ...
        if (rdoSex.SelectedValue.ToString() != "")
        {
            strSql += " and  sex = '" + rdoSex.SelectedValue.ToString() + "'";
        }
        DataRow dr = null;
        Dictionary<string, object> dict = new Dictionary<string, object>();

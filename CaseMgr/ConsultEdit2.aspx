<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ConsultEdit2.aspx.cs" Inherits="CaseMgr_ConsultEdit2" %>
...
//             document.getElementById("ddlstrHour").value = 20;
//             document.getElementById("ddlstrMin").value = 20;
         ...
         function dateDiff(date1, date2) {
            ...
            //alert(document.getElementById("ddlstrHour").value);
    ...
    <script type="text/javascript">
        ...
        function IsDate() {
            var charkc = window.event.keyCode
            if ((charkc >= 48 && charkc <= 57) || charkc == 47) {
                return true;
            }
            return false;
        }
                ...
                <fieldset id="Fieldset1" runat="server" style="border-color: Orange">
                    <legend id="Legend4" runat="server" style="color: Red">個案基本資料 新增/修改</legend>
                        ...
                        <tr>
                         <th align="center"  rowspan ="5" style="Width:30mm">
                            ...
                            <td style="Width:50mm">
                                <asp:TextBox runat="server" ID="txtPhone" Width="40mm" onkeypress="return IsFloatText();" ></asp:TextBox>
                    ...
                    <div Id="IsNotChristian" runat="server">                                                                                
                      ...
                      <tr>
                            ...
                            <td  colspan ="1">
                            開始日期：<asp:TextBox  
                                    runat="server" Width="28mm" ID="txtCreateDate" MaxLength="10" 
                                    onkeypress="return IsDate();" Enabled="False"></asp:TextBox>
                            ...
                            結束時間：
                              <asp:TextBox runat="server" Width="18mm" ID="txtEndTime" MaxLength="8" 
                                    onkeypress="return IsTime();" Visible="False"></asp:TextBox>

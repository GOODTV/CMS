...
public partial class CaseMgr_ConsultEdit2 : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //Response.Write("MemberUID-->" + HFD_MemberID.Value + "<BR>");
            //Response.Write("HFD_UID-->" + HFD_UID.Value + "<BR>");
            //Response.Write("HFD_ConsultingUID-->" + HFD_ConsultingUID.Value + "<BR>");
    ...
    private void SetButton()
    {
        ...
        txtCreateDate.Enabled = (SessionInfo.GroupName == "系統管理員") ? true : false;
   ...
   private void LoadFormData()
    {
        ...
        if (HFD_Mode.Value != "ADD")
        {
            ...
            strSql = @"
                   select *,ISNULL(PrayerDate,'') as PrayerDateS ,CONVERT(varchar(50), PrayerDate, 111) as PrayerDateY
                   from Member
                   where uid=@uid
            ...
            strSql = @"
                   ...
                   and isnull(IsDelete, '') != 'Y'
                  ";
            dict2.Add("MemberUID", "" + HFD_MemberID.Value + "");
            dt2 = NpoDB.GetDataTableS(strSql, dict2);
            if (dt2.Rows.Count > 0)
            {
                dr2 = dt2.Rows[0];
                ConsultCount.Text = dr2["count"].ToString();
            }
        }
       ...
       // txtFileName.Text = (HFD_Mode.Value == "ADD") ? "" : dr["FileName"].ToString();
        ...
        //非基督徒問題選項2015/10/2新增
        //不能轉介原因
        HFD_NotChangeChurch.Value = (HFD_Mode.Value == "ADD") ? "" : dr["NotChangeChurch"].ToString();
        //收看哪些GOODTV節目
        HFD_GoodTVProgram.Value = (HFD_Mode.Value == "ADD") ? "" : dr["GoodTVProgram"].ToString();
        //如何知道家庭關懷專線
        rdoKnowConcernLine.SelectedValue = (HFD_Mode.Value == "ADD") ? "" : dr["KnowConcernLine"].ToString();
        //決志禱告
        txtPrayer.Text = (HFD_Mode.Value == "ADD") ? "" : dr["Prayer"].ToString();
        //決志日期
        if (DateTime.Parse(dr["PrayerDateS"].ToString()).ToString("yyyy/MM/dd") != "1900/01/01")
        {
            txtPrayerDate.Text = (HFD_Mode.Value == "ADD") ? "" : dr["PrayerDateY"].ToString();
        }
        else
        {
            txtPrayerDate.Text = "";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else  //若沒有UID 表示沒有會友資料 要Insert
        {
            ...
            //Response.Write(" HFD_UID1-->" + HFD_UID.Value + "<BR>");
        }
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        if (SessionInfo == null)
        {
            ...
            //Response.Write("請先登入系統再做儲存以免資料遺失!");
        ...
        else  //若沒有UID 表示沒有會友資料 要Insert
        {
            ...
            //Response.Write("HFD_UID2-->" + HFD_UID.Value + "<BR>");
            //Response.Write("MemberUID1-->" + HFD_MemberID.Value + "<BR>");
        }
        ...
        this.Response.Write(@"<script>self.opener.LoadConsultQry('LoadGird');</script>");
    ...
    private void SetColumnData(List<ColumnData> list)
    {
        ...
        //非基督徒問題選項2015/10/2新增
        //不能轉介原因
        list.Add(new ColumnData("NotChangeChurch", HFD_NotChangeChurch.Value.ToString().TrimEnd(','), true, true, false));
        //收看哪些GOODTV節目
        list.Add(new ColumnData("GoodTVProgram", HFD_GoodTVProgram.Value.ToString().TrimEnd(','), true, true, false));
        //如何知道家庭關懷專線
        list.Add(new ColumnData("KnowConcernLine", rdoKnowConcernLine.SelectedValue, true, true, false));
        //決志禱告
        list.Add(new ColumnData("Prayer", txtPrayer.Text, true, true, false));
        //決志日期
        list.Add(new ColumnData("PrayerDate", txtPrayerDate.Text.Trim(), true, true, false));
    ...
    private void LoadHiddenData()
    {
        ...
        //不能轉介原因
        list = new List<ControlData>();
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch1", "嚴重精神疾病", "嚴重精神疾病", false, HFD_NotChangeChurch.Value));
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch2", "不能常去", "不能常去", false, HFD_NotChangeChurch.Value));
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch3", "家中長輩反對", "家中長輩反對", false, HFD_NotChangeChurch.Value));
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch4", "配偶(先生)攔阻", "配偶(先生)攔阻", false, HFD_NotChangeChurch.Value));
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch5", "還沒準備好不敢去", "還沒準備好不敢去", false, HFD_NotChangeChurch.Value));
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch6", "家醜不外揚", "家醜不外揚", false, HFD_NotChangeChurch.Value));
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch7", "宗教信仰因素尚無法突破", "宗教信仰因素尚無法突破", false, HFD_NotChangeChurch.Value));
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch8", "只希望經濟援助", "只希望經濟援助", false, HFD_NotChangeChurch.Value));
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch9", "對教會失望", "對教會失望", false, HFD_NotChangeChurch.Value));
        list.Add(new ControlData("Checkbox", "NotChangeChurch", "CHK_NotChangeChurch10", "只想找人聊聊沒準備去教會", "只想找人聊聊沒準備去教會", false, HFD_NotChangeChurch.Value));
        lblNotChangeChurch.Text = HtmlUtil.RenderControl(list);
        //收看哪些GOODTV節目
        list = new List<ControlData>();
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram1", "真情部落格", "真情部落格", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram2", "孫叔叔唱副歌", "孫叔叔唱副歌", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram3", "幸福來敲門", "幸福來敲門", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram4", "好戲連台(歌仔戲)", "好戲連台(歌仔戲)", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram5", "劉三講古", "劉三講古", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram6", "幸福學堂", "幸福學堂", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram7", "Joe Osteen", "Joe Osteen", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram8", "音樂類節目", "音樂類節目", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram9", "家庭類節目", "家庭類節目", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram10", "佈道類節目", "佈道類節目", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram11", "兒少類節目", "兒少類節目", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram12", "講道類節目", "講道類節目", true, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram13", "影集/電影", "影集/電影", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram14", "禱告會", "禱告會", false, HFD_GoodTVProgram.Value));
        list.Add(new ControlData("Checkbox", "GoodTVProgram", "CHK_GoodTVProgram15", "教會新聞", "教會新聞", false, HFD_GoodTVProgram.Value));
        lblGoodTVProgram.Text = HtmlUtil.RenderControl(list);
    }
    ...
    private string  chkField()
    {
        ...
        //if (isTime(txtCreateTime.Text) == false && txtCreateTime .Text !="")
        //{
        //    txtCreateTime.Text = "";
        //    return "時間格式錯誤，格式為 hh:mm:ss";
        //}
        //if (isTime(txtEndTime.Text) == false && txtEndTime.Text !="")
        //{
        //    txtEndTime.Text = "";
        //    return "時間格式錯誤，格式為 hh:mm:ss";
        //}

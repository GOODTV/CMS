...
public partial class CaseMgr_QryReport :  BasePage 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblConsultingCount.Text = ConsultingCount();
    }
    ...
    private DataTable GetDataTable()
    {
        string strSql = @"
                  select ISNULL((SELECT [Name] FROM CodeCity WHERE CodeCity.Zipcode = City),'')  + ISNULL((SELECT Name FROM CodeCity WHERE CodeCity.zipcode = b.ZipCode),'') + [address] as FullAddress ,b.Memo as M_Memo,*
                        ,ISNULL(PrayerDate,'') as PrayerDateS ,CONVERT(varchar(50), PrayerDate, 111) as PrayerDateY                         
                        from Consulting a  
    ...
    private string GetReport()
    {
        ...
        foreach (DataRow dr in dt.Rows)
        {
            ...
            if (dr["Christian"].ToString() != "是")
            {
                ...
                Util.AddTDLine(css, 123, strColor);
                cell.ColSpan = 3;
                cell.InnerHtml = "不能轉介原因：<span style=" + strMemberColor + " >" + dr["NotChangeChurch"].ToString() + "</span>";
                row.Cells.Add(cell);
                table.Rows.Add(row);
                ...
                Util.AddTDLine(css, 123, strColor);
                cell.ColSpan = 3;
                cell.InnerHtml = "收看哪些GOODTV節目：<span style=" + strMemberColor + " >" + dr["GoodTVProgram"].ToString() + "</span>";
                row.Cells.Add(cell);
                table.Rows.Add(row);
                ...
                Util.AddTDLine(css, 123, strColor);
                cell.ColSpan = 3;
                cell.InnerHtml = "如何知道家庭關懷專線：<span style=" + strMemberColor + " >" + dr["KnowConcernLine"].ToString() + "</span>";
                row.Cells.Add(cell);
                table.Rows.Add(row);
                ...
                Util.AddTDLine(css, 123, strColor);
                cell.ColSpan = 2;
                cell.InnerHtml = "決志禱告：<span style=" + strMemberColor + " >" + dr["Prayer"].ToString() + "</span>";
                row.Cells.Add(cell);
                table.Rows.Add(row);
                ...
                {
                    cell.InnerHtml = "決志日期：<span style=" + strMemberColor + " >" + dr["PrayerDateY"].ToString() + "</span>";
                }
                else
                {
                    cell.InnerHtml = "決志日期：";
    ...
    private string ConsultingCount()
    {
        ...
        dr = dt.Rows[0];
        string ConsultingCount = dr["count"].ToString();

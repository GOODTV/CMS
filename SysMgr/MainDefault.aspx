...
<body class="body">
    <form id="Form1" name="form" runat="server">
        ...
        <asp:HiddenField ID="HFD_shownews" runat="server" />
        <div id="menucontrol">
            <a href="#">
            ...
            <tr>
                <td width="100%" valign="top" align="center">
                    ...
                    <!--a href="../filemgr/News_Show_List.aspx">
                        <img border="0" src="../images/all.gif" alt="" width="63" height="21" align="right" />
                        &nbsp;&nbsp;</a-->
                    <asp:ImageButton id="news_more" runat="server"
                       AlternateText="right"
                       ImageAlign="right"
                       ImageUrl="../images/more.gif"
                       OnClick="ImageButton_Click"/>
                    <asp:ImageButton id="back" runat="server"
                       AlternateText="back"
                       ImageAlign="right"
